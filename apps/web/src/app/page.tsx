...
const campaignCards = [
  { title: "Weekend wellness basket", copy: "Bundle vitamins, oral care, and first-aid essentials for the home.", tone: "bg-[#fff4dc]" },
  { title: "Pharmacist quick check", copy: "Customers can choose pharmacist-led guidance before checkout.", tone: "bg-[#e4f6f1]" },
  { title: "Delivery from your nearest branch", copy: "Location-aware branch selection keeps fulfilment local and clear.", tone: "bg-[#e8f0ff]" },
];
    ...
    <main className="app-shell overflow-hidden">
          ...
          <div className="grid items-end gap-8 pb-12 pt-20 lg:grid-cols-[1fr_380px]">
            <div>
              ...
              <h1 className="max-w-3xl text-4xl font-semibold leading-tight md:text-6xl">
                Bright, trusted pharmacy care delivered from the branch near you.
              </h1>
      ...
      <section id="services" className="page-wrap py-14">
        <div className="mb-8 flex flex-col justify-between gap-4 md:flex-row md:items-end">
          <div>
            ...
            <h2 className="mt-2 max-w-2xl text-3xl font-semibold text-[color:var(--secondary)]">
        ...
        <div className="grid gap-3 md:grid-cols-4">
          {careServices.map((service) => (
            <article key={service.title} className="clinical-card service-pop rounded-lg p-5">
      ...
      <section className="bg-white py-14">
        <div className="page-wrap grid gap-8 lg:grid-cols-[0.8fr_1.2fr]">
          ...
          <div className="product-marquee rounded-lg border border-[color:var(--border)] bg-[color:var(--surface-muted)] p-4">
      ...
      <section className="page-wrap py-14">
        <div className="grid gap-3 md:grid-cols-3">
          {campaignCards.map((card) => (
            <article key={card.title} className={`${card.tone} rounded-lg border border-[color:var(--border)] p-6`}>
      ...
      <section className="bg-[color:var(--secondary)] pt-12 text-white">
        <div className="page-wrap grid gap-8 pb-20 md:grid-cols-3">
          <div>
            <h2 className="text-2xl font-semibold">A pharmacy system with real operational muscle.</h2>
