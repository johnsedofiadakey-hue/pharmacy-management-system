...
| 17 | Repo Recovery, Critical UX Fixes & Visual Redesign | Built (gitignore fix + full lib reconstruction both sides, persistent/editable carts, checkout-surviving signup, till rehydration, failed-offline-sale review queue, clinical-trust design system with Satoshi/Inter, public/storefront/POS reskins; portal pages reskin + live verification of reconstructed lib pending) | [phase-17-recovery-critical-ux-fixes-redesign.md](docs/phases/phase-17-recovery-critical-ux-fixes-redesign.md) |
